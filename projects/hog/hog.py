...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0,score1):
        if who == 0:
            newsc = score0 - last_score
            if newsc > running_high:
                print(newsc,'point(s)! The most yet for Player 0')
            else:
                newsc = running_high
            return announce_highest(who,score0,newsc)
        elif who == 1:
            newsc = score1 - last_score
            if newsc > running_high:
                print(newsc,'point(s)! The most yet for Player 1')
            else:
                newsc = running_high
            return announce_highest(who,score1,newsc)
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    add_sc = free_bacon(opponent_score)
    if extra_turn(score + add_sc,opponent_score):
        return 0
    elif add_sc >= cutoff:
        return 0
