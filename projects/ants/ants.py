...
# END Problem EC
    ...
    def __init__(self, armor=1):
        ...
        QueenAnt.has_queen += 1
        self.n = QueenAnt.has_queen         # the nth queen to appear
        # END Problem EC
    ...
    def action(self, gamestate):
        ...
        if self.n > 1:
            ...
            return
        ThrowerAnt.action(self, gamestate)      # Queen is a Thrower which could attack
        p = self.place.exit
        while p is not None:
            if p.ant is not None and p.ant not in QueenAnt.has_double:
                p.ant.damage *= 2
                QueenAnt.has_double.add(p.ant)
            p = p.exit
        # END Problem EC
